        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TanksInTruck = table.Column<int>(type: "integer", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AddDriverRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AddDriverRequests_AspNetUsers_RequestedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ElectricityBalances", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ElectricityBalances_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ElectricityBalances_Shops_ShopId",
                        column: x => x.ShopId,
                        principalTable: "Shops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AddDriverRequests_RequestedById",
                table: "AddDriverRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ElectricityBalances_ShopId",
                table: "ElectricityBalances",
                column: "ShopId");

            migrationBuilder.CreateIndex(
                name: "IX_ElectricityBalances_UserId",
                table: "ElectricityBalances",
                column: "UserId");
